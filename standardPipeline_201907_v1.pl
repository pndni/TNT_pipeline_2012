...
# Nick - JANUARAY 23, 2012
# 1) Changed the Template to SYS_808
# 2) Change the classfy tag to the sys808.tag warped from icbm152

# Nick - FEBUARAY 9, 2012
# 1) Changed the output volume variable names to e.g. FrontalRightWM
...
my @argTbl = 
	(
		...
		["-atlaslabels", "string", 1, \$atlasModel,
		"set the file for the segmentation masks."],
